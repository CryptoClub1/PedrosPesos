...
// PPoin: sync-checkpoint master key
...
// PPoin: synchronized checkpoint (centrally broadcasted)
...
// PPoin: get last synchronized checkpoint
...
// PPoin: only descendant of current sync-checkpoint is allowed
...
// PPoin: reset synchronized checkpoint to last hardened checkpoint
...
// PPoin: find block wanted by given orphan block
...
// PPoin: verify signature of sync-checkpoint message
...
// PPoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in PPoin)
