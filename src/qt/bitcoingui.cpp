...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/PedrosPesos"));
    setWindowIcon(QIcon(":icons/PedrosPesos"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PedrosPesos address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/PedrosPesos"), tr("&About PedrosPesos"), this);
    aboutAction->setStatusTip(tr("Show information about PedrosPesos"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for PedrosPesos"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/PedrosPesos"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PedrosPesos addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PedrosPesos addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/PedrosPesos"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://PedrosPesos.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/PedrosPesos"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.PedrosPesos.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/PedrosPesos_testnet"));
            setWindowIcon(QIcon(":icons/PedrosPesos_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/PedrosPesos_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PedrosPesos client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://PedrosPesos.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.PedrosPesos.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PedrosPesos network", "", count));
}
...
{
    QString strTitle = tr("PedrosPesos"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PedrosPesos address or malformed URI parameters."),
