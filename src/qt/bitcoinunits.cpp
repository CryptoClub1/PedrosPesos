...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PP");
    case mBTC: return QString("mPP");
    case uBTC: return QString::fromUtf8("μPP");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PedrosPesoss");
    case mBTC: return QString("Milli-PedrosPesoss (1 / 1,000)");
    case uBTC: return QString("Micro-PedrosPesoss (1 / 1,000,000)");
    default: return QString("???");
    }
}
