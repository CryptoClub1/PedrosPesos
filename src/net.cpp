...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("PedrosPesos-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PedrosPesos " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seedPedrosPesos", "seed.PedrosPesos.net"},
    {"seed", "seed.PPoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseedPedrosPesos", "tseed.PedrosPesos.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PedrosPesos is probably already running."), addrBind.ToString().c_str());
        else
