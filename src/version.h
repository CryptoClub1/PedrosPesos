...
static const int PedrosPesos_VERSION =
                           1000000 * PedrosPesos_VERSION_MAJOR
                         +   10000 * PedrosPesos_VERSION_MINOR
                         +     100 * PedrosPesos_VERSION_REVISION
                         +       1 * PedrosPesos_VERSION_BUILD;
